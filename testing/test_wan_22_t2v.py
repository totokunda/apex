...
engine = create_engine("wan", "manifest/wan/wan_22_t2v_14b.yml", "t2v", save_path="/workspace/models", attention_type="flash3", component_dtypes={"text_encoder": torch.float32}, denoise_type="moe")
