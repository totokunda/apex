...
engine = create_engine("magi", "manifest/magi/magi_x2v_4_5b.yml", "t2v", save_path="/workspace/models", attention_type="flash", component_dtypes={"text_encoder": torch.float32})
