...
engine = create_engine("stepvideo", "manifest/stepvideo/stepvideo_t2v_13b.yml", "t2v", save_path="/dev/shm/models", attention_type="flash", component_dtypes={"text_encoder": torch.float32})
