...
engine = create_engine("wan", "manifest/wan/wan_apex_frampack_t2v_14b.yml", "apex_framepack", save_path="/workspace/models", attention_type="flash3", component_dtypes={"text_encoder": torch.float32})
...
export_to_video(video[0], "test_wan_apexframepack_t2v_space.mp4", fps=16, quality=8)