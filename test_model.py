...
export_to_video(out[0], "fflf_output.mp4", fps=16)

# out[0].save("qwenimage_edit_output.png")
...
#         out[0].save("output.mp4", save_all=True, append_images=out[1:], duration=1000/inputs.get("fps", 16), loop=0)
