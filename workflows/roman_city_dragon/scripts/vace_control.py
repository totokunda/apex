...
images = [
    Image.open('/data/apex/workflows/roman_city_dragon/assets/images/frame_49.png')
]

control_video = "/data/apex/workflows/roman_city_dragon/assets/depth/depth_dragon_flux_kontext_continuation_1_cut.mp4"
# get the number of frames in the control video
control_video_path = "/data/apex/workflows/roman_city_dragon/assets/depth/depth_dragon_flux_kontext_continuation_1_cut.mp4"
...
export_to_video(video[0], "assets/control/vace_control_2.mp4", fps=16, quality=9)