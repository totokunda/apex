...
engine = create_engine("hunyuan", "manifest/hunyuan/hunyuan_framepack_13b.yml", "framepack", save_path="/workspace/models", attention_type="sdpa", component_dtypes={"text_encoder": torch.float32})
...
outfile_path = "test_hunyuan_framepack_i2v.mp4"
export_to_video(video[0], outfile_path, fps=30, quality=8)
