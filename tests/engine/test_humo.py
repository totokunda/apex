...
yaml_path = "/home/tosin_coverquick_co/apex/manifest/engine/wan/humo-17b-1.0.0.v1.yml"
...
video_path = "output3_fibo_singing_humo.mp4"
export_to_video(out[0], video_path, fps=25)
...
subprocess.run(
    [
        ...
        "aac",
        "-shortest",
        "output3_fibo_singing_with_audio_humo.mp4",
    ],
    check=True,
)