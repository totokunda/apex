...
from src.auxillary.util import resize_image_with_pad, common_input_validate, HWC3
...
class CannyDetector(BasePreprocessor):
    ...
    def process(self, input_image=None, low_threshold=100, high_threshold=200, detect_resolution=512, upscale_method="INTER_CUBIC", **kwargs):
