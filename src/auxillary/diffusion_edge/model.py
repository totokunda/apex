...
import math
import torch
from src.auxillary.diffusion_edge.denoising_diffusion_pytorch.utils import *
from src.auxillary.diffusion_edge.denoising_diffusion_pytorch.encoder_decoder import AutoencoderKL
# from custom_controlnet_aux.diffusion_edge.denoising_diffusion_pytorch.transmodel import TransModel
from src.auxillary.diffusion_edge.denoising_diffusion_pytorch.uncond_unet import Unet
from src.auxillary.diffusion_edge.denoising_diffusion_pytorch.data import *
...
class DiffusionEdge:
    def __init__(self, args) -> None:
        ...
        if model_cfg.model_name == 'cond_unet':
            from src.auxillary.diffusion_edge.denoising_diffusion_pytorch.mask_cond_unet import Unet
        ...
        if model_cfg.model_type == 'const_sde':
            from src.auxillary.diffusion_edge.denoising_diffusion_pytorch.ddm_const_sde import LatentDiffusion
        else:
