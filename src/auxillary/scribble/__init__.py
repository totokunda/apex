...
class ScribbleDetector(BasePreprocessor):
    ...
    def process(self, input_image: InputImage, detect_resolution=512, upscale_method="INTER_AREA", **kwargs) -> OutputImage:
...
class ScribbleXDogDetector(BasePreprocessor):
    ...
    def process(self, input_image: InputImage, detect_resolution=512, thr_a=32, upscale_method="INTER_CUBIC", **kwargs) -> OutputImage:
        input_image = self._load_image(input_image)
