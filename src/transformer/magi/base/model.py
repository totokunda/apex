...
from src.attention.processors.magi_processor import Magi1AttnProcessor2_0
...
class Magi1TimeTextImageEmbedding(nn.Module):
    ...
    def __init__(
        ...
        if image_embed_dim is not None:
            self.image_embedder = Magi1ImageEmbedding(
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.proj_out = nn.Linear(
            inner_dim, out_channels * math.prod(patch_size), bias=False
        )
