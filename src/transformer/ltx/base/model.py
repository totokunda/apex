...
class LTXVideoFeedForward(nn.Module):
    r"""
...
class LTXVideoAttention(nn.Module):
    r"""
    ...
    def get_processor(
    ...
    ) -> "LTXVideoAttentionProcessor":  # noqa: F821
        r"""
        ...
        Returns:
            "LTXVideoAttentionProcessor": The attention processor in use.
        """
...
class LTXVideoRotaryPosEmbed(nn.Module):
    ...
    def forward(self, indices_grid, hidden_states, spacing="exp"):
        ...
        return cos_freq.to(hidden_states.dtype), sin_freq.to(hidden_states.dtype)
...
@maybe_allow_in_graph
@TRANSFORMERS_REGISTRY("ltx.base")
class LTXVideoTransformer3DModel(
    ...
    def forward(
        ...
        freqs_cis = self.rope(video_coords, hidden_states)
