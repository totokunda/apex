...
class MagiTransformerConverter(TransformerConverter):
    def __init__(self):
        ...
        self.rename_dict = {
            ...
            "self_attention.k_layernorm_xattn.bias": "attn2.norm_k.bias",
            "self_attention.k_layernorm_xattn.weight": "attn2.norm_k.weight",
            "self_attention.k_layernorm.bias": "attn1.norm_k.bias",
            "self_attention.k_layernorm.weight": "attn1.norm_k.weight",
            "self_attention.q_layernorm_xattn.bias": "attn2.norm_q.bias",
            "self_attention.q_layernorm_xattn.weight": "attn2.norm_q.weight",
