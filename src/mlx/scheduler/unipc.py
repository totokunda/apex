...
class FlowUniPCMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        sigmas = 1.0 - alphas
        sigmas = mx.array(sigmas).to(dtype=mx.float32)
    ...
    def _threshold_sample(self, sample: mx.array) -> mx.array:
        ...
        s = mx.quantile(abs_sample, self.config.dynamic_thresholding_ratio, dim=1)
        s = mx.clip(
    ...
    def multistep_uni_p_bh_update(
        ...
        **kwargs,
        ...
        if self.predict_x0:
            ...
            if D1s is not None:
                pred_res = mx.einsum("k,bkc...->bc...", rhos_p, D1s)  # pyright: ignore
            else:
                pred_res = 0
