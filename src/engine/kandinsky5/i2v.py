...
class Kandinsky5I2VEngine(Kandinsky5Shared):
    """Kandinsky 5.0 image-to-video engine implemented from the diffusers pipeline."""
    ...
    def prepare_latents_with_image(
        ...
        # Convert from (B, C, T, H, W) to (B, T, H, W, C) to match latent layout
    ...
    def run(
        ...
        **kwargs,
        ...
        if output_type == "latent":
            ...
            output = self._tensor_to_frames(video, output_type=output_type)
