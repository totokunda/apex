...
class ModelBase:
    ...
    def __init__(
        ...
        *,
        ...
        self.dir_tokenizer = dir_tokenizer
        self.ftype = ftype
...
class TextModel(ModelBase):
    ...
    def _create_vocab_sentencepiece(self):
        ...
        if self.dir_tokenizer is not None:
            tokenizer_path = self.dir_tokenizer / "tokenizer.model"
        else:
        ...
        if self.dir_tokenizer is not None:
            added_tokens_file = self.dir_tokenizer / "added_tokens.json"
        else:
        ...
        if self.dir_tokenizer is not None:
            tokenizer_config_file = self.dir_tokenizer / "tokenizer_config.json"
        else:
...
class LlavaVisionModel(MmprojModel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.hparams.get("model_type") == "pixtral":
            ...
            assert (
                self.hparams["norm_eps"] is not None
...
@ModelBase.register("UMT5EncoderModel")
