...
class PyraCannyDetector(BasePreprocessor):
    @classmethod
    def from_pretrained(cls):
        """PyraCannyDetector doesn't require pretrained models"""
        return cls()
    
    def process(self, input_image: InputImage, low_threshold=100, high_threshold=200, detect_resolution=512, upscale_method="INTER_CUBIC", **kwargs) -> OutputImage:
