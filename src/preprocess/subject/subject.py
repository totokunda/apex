...
class SubjectPreprocessor(BasePreprocessor):
    def __init__(self, mode: str = "salientmasktrack", use_aug: bool = False, use_crop: bool = False, 
                 roi_only: bool = False, return_mask: bool = True, inpainting_config: dict = None, **kwargs):
        ...
        if inpainting_config is not None:
            warnings.warn("Inpainting functionality requires additional dependencies and is not fully implemented.")
