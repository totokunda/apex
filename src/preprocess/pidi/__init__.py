...
class PidiNetDetector(ToMixin, BasePreprocessor):
    ...
    def process(self, input_image: InputImage, detect_resolution=512, safe=False, scribble=False, apply_filter=False, upscale_method="INTER_CUBIC", **kwargs) -> OutputImage:
