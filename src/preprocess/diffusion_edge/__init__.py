...
from src.preprocess.util import HWC3, resize_image_with_pad, custom_hf_download, DIFFUSION_EDGE_MODEL_NAME
...
class DiffusionEdgeDetector(ToMixin, BasePreprocessor):
    ...
    def process(self, input_image: InputImage, detect_resolution=512, patch_batch_size=8, upscale_method="INTER_CUBIC", **kwargs) -> OutputImage:
