...
@preprocessor_registry("wan.recam")
class RecamPreprocessor(BasePreprocessor):
    def __init__(self, cam_type: int = 1, preprocessor_type: PreprocessorType = PreprocessorType.POSE, **kwargs):
        super().__init__(preprocessor_type=preprocessor_type, **kwargs)
