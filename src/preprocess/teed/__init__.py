...
from src.preprocess.util import safe_step, custom_hf_download, BDS_MODEL_NAME, resize_image_with_pad, HWC3
...
class TEDDetector(ToMixin, BasePreprocessor):
    ...
    def process(self, input_image: InputImage, detect_resolution=512, safe_steps=2, upscale_method="INTER_CUBIC", **kwargs) -> OutputImage:
