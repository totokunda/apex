...
from src.preprocess.util import HWC3, resize_image_with_pad, custom_hf_download, DEPTH_ANYTHING_V2_MODEL_NAME_DICT
from src.preprocess.depth_anything_v2.dpt import DepthAnythingV2
import cv2
...
class DepthAnythingV2Detector(ToMixin, BasePreprocessor):
    ...
    def process(self, input_image: InputImage, detect_resolution=512, upscale_method="INTER_CUBIC", max_depth=20.0, **kwargs) -> OutputImage:
