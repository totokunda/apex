...
def ready_arguments(fname_or_dict, posekey4vposed='pose'):
    import numpy as np
    import pickle
    from src.preprocess.mesh_graphormer.custom_manopth.posemapper import posemap
...
def load_model(fname_or_dict, ncomps=6, flat_hand_mean=False, v_template=None):
    ...
    from src.preprocess.mesh_graphormer.custom_manopth.verts import verts_core
    import numpy as np
    import pickle
