...
class SAM2Preprocessor(BasePreprocessor):
    def __init__(self, config_path: str, model_path: str, task_type: str = 'input_box', 
...
class SAM2VideoPreprocessor(BasePreprocessor):
    def __init__(self, config_path: str, model_path: str, task_type: str = 'input_box', 
        ...
        super().__init__(model_path=model_path, preprocessor_type=PreprocessorType.VIDEO, **kwargs)
        ...
        self.video_predictor = build_sam2_video_predictor(local_config_path, self.model_path)
...
warnings.warn("SAM2SalientVideoPreprocessor and SAM2GDINOVideoPreprocessor require additional dependencies and are not implemented yet.") 