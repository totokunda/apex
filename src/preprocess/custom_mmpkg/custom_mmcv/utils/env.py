...
def collect_env():
    ...
    if cuda_available:
        ...
        from src.preprocess.custom_mmpkg.custom_mmcv.utils.parrots_wrapper import _get_cuda_home
    ...
    try:
        from src.preprocess.custom_mmpkg.custom_mmcv.ops import get_compiler_version, get_compiling_cuda_version
    except ModuleNotFoundError:
