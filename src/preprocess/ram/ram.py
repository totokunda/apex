...
class RAMPreprocessor(BasePreprocessor):
    def __init__(self, tokenizer_path: str, model_path: str, image_size: int = 384, 
                 ram_type: str = 'swin_l', return_lang: List[str] = None, 
        ...
        try:
            ...
            import warnings
            warnings.warn("please pip install ram package, or you can refer to models/VACE-Annotators/ram/ram-0.1.0-py3-none-any.whl")
            raise ImportError("RAM package not available")

        self.return_lang = return_lang if return_lang is not None else ['en']  # ['en', 'zh']
