...
def validate_compute_requirements(
    ...
    if current_capability.compute_type == "cuda":
        ...
        current_arch = get_cuda_architecture_from_capability(current_capability.cuda_compute_capability)
        current_arch_name = get_cuda_capability_name(current_capability.cuda_compute_capability)
