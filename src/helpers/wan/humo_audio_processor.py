...
class HuMoAudioProcessor(BaseHelper):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if audio_separator_model_name is not None and audio_separator_model_path is not None:
            try:
                os.makedirs(cache_dir, exist_ok=True)
            except OSError as _:
                print("Fail to create the output cache dir.")
            audio_separator_model_path = self._download(audio_separator_model_path, get_components_path())
