...
class HunyuanVisionEncoder(BaseHelper):
    """
    Helper wrapper around the HunyuanVideo 1.5 vision encoder.

    This is kept lightweight so it can be auto-loaded through the engine
    helper registry and moved between devices as needed.
    """
    ...
    def __init__(
        ...
        vision_encoder_precision: Optional[str] = "fp16",
        processor_type: Optional[str] = None,
        processor_path: Optional[str] = None,
        output_key: Optional[str] = None,
        ...
        **kwargs: Any,
        ...
        vision_path = self._download(model_path, get_components_path())
    ...
    def encode_latents(self, latents, vae, reorg_token: bool = False):
        return self.encoder.encode_latents(latents, vae, reorg_token=reorg_token)
