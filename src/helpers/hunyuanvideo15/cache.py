...
class CacheHelper:
    def __init__(self, model=None, timesteps=None, no_cache_steps=None, no_cache_block_id=None, no_cache_layer_id=None):
        if model is not None: 
            self.model = model
            self.double_blocks = model.double_blocks
    ...
    def wrap_modules(self):
        for block_i, block in enumerate(self.model.double_blocks):
