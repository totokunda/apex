...
class OffloadableModule(nn.Module):
    ...
    def __init__(self, module: nn.Module, config: MemoryConfig, memory_monitor, 
...
def wrap_module(module: nn.Module, config: MemoryConfig, memory_monitor, 
                module_id: Optional[str] = None) -> OffloadableModule:
...
def wrap_model_layers(model: nn.Module, config: MemoryConfig, memory_monitor,
